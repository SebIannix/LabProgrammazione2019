...
func main() {
	...
	var a, b int = 10, 5
	fmt.Println("Funzione 'main' - Valori di 'a' e 'b' prima di chiamare/invocare la funzione 'test'.")
	fmt.Println(a, b)
	b = test(a)
	fmt.Println("Funzione 'main' - Valori di 'a' e 'b' dopo aver chiamato/invocato la funzione 'test'.")
	fmt.Println(a, b)
